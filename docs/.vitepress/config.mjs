    ...
    themeConfig: {
        ...
        nav: [
            ...
            },
            {
                ...
                items: [
                    {text: '后端', link: '/backend'},
                    {
                        text: 'Git',
                        items: [
                            {text: 'GitInAction', link: '/backend/Git/GitInAction'},
                        ]
                    },
            ...
            },
            {
                ...
                items: [{text: '设计', link: '/ui-design'}]
            },
            {text: '大数据', link: '/big-data'},
            {text: 'AI大模型', link: '/ai-llm'},
        ...
        footer: {
            ...
            copyright: 'Copyright © 2025 版权所有 | 浙ICP备2023025841号 | 星舰通讯：contact@cogniverse.cn'
        },
