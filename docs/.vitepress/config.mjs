...
export default defineConfig({
    ...
    themeConfig: {
        ...
        nav: [
            ...
            },
            {
                ...
                items: [
                    ...
                    {text: 'Pi', link: '/aillm/Pi/00-引言'},
                    {text: 'Qoder', link: '/aillm/Qoder/00-引言'},
        ...
        sidebar: {
            ...
            '/aillm/Pi': autoGenSidebar('/aillm/Pi'),
            '/aillm/Qoder': autoGenSidebar('/aillm/Qoder'),
