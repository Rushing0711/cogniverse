...
#### 2.9.1 简单快速处理方式（治标不治本）

临时快速解决问题的方式，重启chronyd服务：

```bash
$ sudo systemctl restart chronyd
```

> 重启后等待几秒，查看`date`应该已经同步了，查看timedatectl应该显示`System clock synchronized: yes`了
>
> 还可以手动同步时间：
>
> ```bash
...
#### 2.9.3 检查并更换同步源（针对物理机场景的可能情况）

参考：[如何检查并更换同步源](http://localhost:8751/devops/new/Linux/05-%E7%AC%AC5%E7%AB%A0%20%E5%AE%9E%E7%94%A8%E6%8C%87%E4%BB%A4.html#_4-4-1-%E5%A6%82%E4%BD%95%E6%A3%80%E6%9F%A5%E5%B9%B6%E6%9B%B4%E6%8D%A2%E5%90%8C%E6%AD%A5%E6%BA%90)
